...
def goods_sn = JC.internal.param('goods_sn');
def pid = JC.internal.param('pid');

logger.info('goods_sn=' + goods_sn);
...
if(typecode==null) {
	page_goods = cat_service.find_sale_goods_by_num(page_goods, goods_sn, '100', pid)
	page_pack = cat_service.find_sale_goods_by_num(page_pack, goods_sn, '200', pid);
	page_merge = cat_service.find_sale_goods_by_num(page_merge, goods_sn, '300', pid);
