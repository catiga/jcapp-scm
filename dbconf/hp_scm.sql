...
CREATE TABLE `data_goods_info` (
  ...
  `c_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `flag` tinyint(4) NOT NULL DEFAULT '0',
  `goods_id` varchar(50) DEFAULT NULL COMMENT '产品编号',
  `goods_name` varchar(255) DEFAULT NULL COMMENT '产品名称',
  `goods_price` decimal(10,2) DEFAULT NULL COMMENT '产品价格',
  `goods_original_price` decimal(10,2) DEFAULT NULL,
  `cost_price` decimal(10,2) DEFAULT NULL,
  `goods_material` varchar(255) DEFAULT '' COMMENT '产品材料',
  `goods_picturelink` varchar(255) DEFAULT NULL COMMENT '产品图片链接',
  `goods_picturelink_big` varchar(255) DEFAULT NULL,
  `goods_state` varchar(4) NOT NULL DEFAULT '0000' COMMENT '产品状态：上架、下架',
  `goods_remark` varchar(1024) DEFAULT '' COMMENT '产品备注',
  `goods_picturelink_middle` varchar(255) DEFAULT NULL,
  `proj_id` bigint(20) NOT NULL DEFAULT '2',
  `model_id` bigint(20) DEFAULT NULL,
  `unit` varchar(255) DEFAULT NULL,
  `config` varchar(255) DEFAULT NULL,
  `weight` decimal(10,2) DEFAULT NULL,
  `spec_unit` char(3) DEFAULT NULL,
  `freepost` tinyint(4) NOT NULL DEFAULT '1',
  `ftpl` bigint(20) DEFAULT NULL,
  `local` varchar(8) NOT NULL DEFAULT '1',
  `limit_buy_num` int(11) NOT NULL DEFAULT '0',
  `stock` int(11) DEFAULT '1',
  `gt` varchar(2) NOT NULL DEFAULT '0',
  `goods_out_no` varchar(255) DEFAULT NULL,
  `goods_code` varchar(225) DEFAULT '' COMMENT '快速检索关键词',
  `other_id` bigint(20) DEFAULT NULL COMMENT '其他信息表id',
  `a_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `proj_id` (`proj_id`),
  KEY `goods_state` (`goods_state`),
  KEY `goods_id` (`goods_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='产品基础信息表';
